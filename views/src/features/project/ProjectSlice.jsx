...
// Register project
export const AddProject = createAsyncThunk("project/add", async (project, thunkAPI) => {
  try {
...
// Login project
export const GetProjects = createAsyncThunk("project/all", async (project, thunkAPI) => {
  try {
...
// Login project
export const GetProject = createAsyncThunk("project/id", async (id, thunkAPI) => {
  try {
